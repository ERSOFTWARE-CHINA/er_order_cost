defmodule RestfulApiWeb.RoleController do
  ...
  import RestfulApiWeb.Permissions, only: [get_number_from_perms: 1, need_perms: 1, get_all_permissions: 0, get_max_perms_number: 0, get_perms_from_number: 1]
  ...
  def list_all_perms(conn, _) do
    ...
    claims = RestfulApiWeb.Guardian.Plug.current_claims(conn)
